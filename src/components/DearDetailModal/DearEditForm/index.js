...
import './dearEditForm.scss';

const DearEditForm = ({ dear, changeIsOpen, parentReload }) => {
  ...
  return (
    <div className="dear-edit-form-wrapper">
      <div className="form">
...
DearEditForm.propTypes = {
  open: PropTypes.bool.isRequired,
  changeIsOpen: PropTypes.func.isRequired,
};

export default DearEditForm;
